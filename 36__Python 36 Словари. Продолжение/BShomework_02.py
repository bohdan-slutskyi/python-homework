...
for word in words:
    ...
    result[word] = letters
print(result)
# - внешний цикл перебирает слова;
# - для каждого слова создаём отдельный словарь letters;
# - .get(letter, 0) берёт текущее количество буквы;
# - если буквы ещё нет, берётся 0;
# - потом прибавляем 1.
